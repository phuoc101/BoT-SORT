...
from yolov7.utils.datasets import LoadStreams, LoadImages  # noqa
from yolov7.utils.general import (  # noqa
    check_img_size,  # noqa
    check_requirements,  # noqa
    check_imshow,  # noqa
    non_max_suppression,  # noqa
    apply_classifier,  # noqa
    scale_coords,  # noqa
    xyxy2xywh,  # noqa
    strip_optimizer,  # noqa
    set_logging,  # noqa
    increment_path,  # noqa
)  # noqa
from yolov7.utils.plots import plot_one_box  # noqa
from yolov7.utils.torch_utils import (  # noqa
    select_device,  # noqa
    load_classifier,  # noqa
    time_synchronized,  # noqa
    TracedModel,  # noqa
)  # noqa
from tracker.mc_bot_sort import BoTSORT  # noqa
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            p = Path(p)  # to Path
            save_path = str(save_dir / "frames" / p.name)  # img.png
            ...
            if save_txt:
                res_file = os.path.join(
                    save_dir, "labels", p.name.replace(".png", ".txt")
                )
